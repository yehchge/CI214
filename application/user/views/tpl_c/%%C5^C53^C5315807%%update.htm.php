<?php /* Smarty version 2.6.26, created on 2013-09-29 22:49:31
         compiled from update.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'update.htm', 53, false),)), $this); ?>
...
index.php/index/post/<?php echo $this->_tpl_vars['blog']['id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['blog']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a> &raquo; <span>更新</span>
	</div><!-- breadcrumbs -->
	
	<div class="container">
	  <div class="span-18">
	    <div id="content">
		  <h1>更新 <i><?php echo ((is_array($_tmp=$this->_tpl_vars['blog']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</i></h1>
			...
			<div class="form">
			  ...
			  <?php echo $this->_tpl_vars['form_hidden']; ?>
				...
				<div class="row">
				  ...
				  <input size="80" maxlength="128" name="title" id="title" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['blog']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
				</div>
				...
				<div class="row">
				  ...
				  <input size="50" id="tags" name="tags" type="text" value="<?php echo $this->_tpl_vars['blog']['tags']; ?>
" />	
